  ...
  return (
    <div>
      ...
      <div className='z-50 absolute top-0 p-5 h-[50px] w-full'>
        ...
        <span className='z-50 absolute flex justify-center items-center top-[15px] right-[15px] bg-[#ffffff70] w-[150px] text-[white] text-center text-[16px] py-3 rounded-full' onClick={handlerPlay}>
