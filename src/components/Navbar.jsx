            ...
            return <ul class="space-y-3 text-[16px]  text-gray-600 font-medium">
                ...
                <li>
                    <Link href="/Cliente" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Tienda</span>
                    </Link>
                </li>
                <li>
            ...
            return <ul class="space-y-2 text-[16px]  text-gray-600 font-medium">
                ...
                <li>
                    <Link href="/Administrador/Medicos" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap text-white hover:text-[#2A52BE] hover:font-medium">Medicos</span>
                    </Link>
                </li>
                <li>
                    <Link href="/Administrador/Clinicas" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap text-white hover:text-[#2A52BE] hover:font-medium">Clinicas</span>
                    </Link>
                </li>
                <li>
