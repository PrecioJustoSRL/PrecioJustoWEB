            ...
            return <ul class="space-y-2 text-[16px]  text-gray-600 font-medium">
                ...
                <li>
                    <Link href="/Cliente" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap text-white">Tienda</span>
                    </Link>
                </li>
                <li>
                    <Link href="/Administrador/Plantilla" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap text-white">Datos de productos</span>
                    </Link>
                </li>
                <li>
                ...
                <li>
                    <Link href="/Administrador/Medicos" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap text-white">Medicos</span>
                    </Link>
                </li>
                <li>
                    <Link href="/Administrador/Clinicas" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap text-white">Clinicas</span>
                    </Link>
                </li>
                <li>
                    <Link href="/Administrador/Distribuidores" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap text-white">Ditribuidores</span>
                    </Link>
                </li>
                <li>
                    <Link href="https://api.whatsapp.com/send?phone=+59169941749&text=hola%20mundo" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap text-white">Soporte</span>
                    </Link>
                </li>
                <li onClick={signOutHandler}>
                    <Link href="/" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
