            ...
            return <ul class="space-y-2 text-[16px]  text-gray-600 font-medium">
                ...
                <li>
                    <Link href="/Administrador/Plantilla" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6  transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                        <span class="flex-1 ml-3 whitespace-nowrap">Datos de productos</span>
                    </Link>
                </li>
                <li>
                    ...
                    <Link href="/Administrador/Clinicas" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_102_384)">
                                <path d="M15 4V0H8V4H0V16H6V13H10V16H16V4H15ZM4 11H2V9H4V11ZM4 8H2V6H4V8ZM7 11H5V9H7V11ZM7 8H5V6H7V8ZM10 3V2H11V1H12V2H13V3H12V4H11V3H10ZM11 11H9V9H11V11ZM11 8H9V6H11V8ZM14 11H12V9H14V11ZM14 8H12V6H14V8Z" fill="#545454" />
                            </g>
                            <defs>
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Clinicas</span>
                    </Link>
                </li>
                <li>
                    <Link href="/Administrador/Distribuidores" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 17H17V14H18V12L17 7H2L1 12V14H2V20H11V14H15V17ZM9 18H4V14H9V18ZM2 4H17V6H2V4Z" fill="#545454" />
                            <path d="M20 18V15H18V18H15V20H18V23H20V20H23V18H20Z" fill="#545454" />
                        </svg>
                        <span class="flex-1 ml-3 whitespace-nowrap">Ditribuidores</span>
                    </Link>
                </li>
                <li>
                    <Link href="https://api.whatsapp.com/send?phone=+59169941749&text=hola%20mundo" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
