...
export default function Home() {
  ...
  return (
    <div className="h-full bg-[#2A52BE]"
      ...
      <Video />
      <div className='w-screen h-screen bg-[#00000090] flex flex-col justify-center items-center p-5'>
        <form className={`space-y-6 lg:space-y-3 w-[100%] max-w-[350px] p-5 ${introVideo == true ? 'h-0 overflow-hidden' : 'h-auto'}`} onSubmit={signInHandler} >
