    ...
    return (
        ...
        <main className="">
            ...
            {user.rol !== 'Distribuidor' && <div>
                <label htmlFor="qr" className='block w-[90vw] relative mb-3 left-0 right-0 m-auto  max-w-[600px] lg:min-w-[600px] flex justify-between items-center text-white text-[16px] h-[50px] bg-[#0064FA] rounded-full py-[5px] px-[20px] z-20'>
