...
function Home() {
    ...
    return (
        ...
        <main className="mg-blue-400">
            ...
            <label htmlFor="qr" className='block w-[90%] sticky top-[75px] left-0 right-0 m-auto relative  max-w-[600px] lg:min-w-[600px] justify-between items-center text-white text-[16px] h-[50px] bg-[#0064FA] rounded-full py-[5px] px-[20px] z-50'>
            ...
            <div className="w-screen lg:w-auto relative ">
                <div className="relative bg-gray-50  px-5 py-16 lg:py-5 lg:bg-transparent rounded-b-[50px] lg:fixed lg:top-[50px] lg:w-[200px]  lg:z-30 lg:right-[50px]">
                        ...
                        <div className=''>
                            <Subtitle styled='text-center' htmlFor="">Categorias</Subtitle>
                            <div className="flex flex-wrap  justify-between">
                ...
                <div className="relative bg-transparent lg:bg-transparent mt-6  rounded-t-[50px]  w-full flex flex-col items-center justify-center px-5 pt-16">
