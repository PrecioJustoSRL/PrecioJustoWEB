    ...
    return (
        ...
        <main className="">
            ...
            {user.rol !== 'Distribuidor' && <div>
                <label htmlFor="qr" className='block w-[90vw] relative mb-3 left-0 right-0 m-auto  max-w-[600px] lg:min-w-[600px] border-[5px] border-blue-500 flex justify-between items-center text-white text-[16px] h-[50px] bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 rounded-full py-[5px] px-[20px]  border-gray-500 z-20' >
                    ...
                    <span className='block w-full h-[28px] absolute left-0 top-0 bottom-0 my-auto text-center pl-[50px]'>Ver recetas QR...</span>
                </label>
